            ...
            >
              ...
              {!transaction.isDeleted ? (
                <button
                  ...
                  className="mt-4 rounded-lg bg-red-100 px-3 py-2 text-sm font-semibold text-red-700 disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={updatingId === transaction.id}
                  className="mt-3 rounded-lg bg-blue-100 px-3 py-2 text-sm font-semibold text-blue-700 disabled:opacity-50"
                >
                  {updatingId === transaction.id
                    ? "Restoring..."
                    : "Restore Order"}
